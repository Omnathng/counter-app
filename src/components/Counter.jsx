        ...
        <div className='d-flex d-flex justify-content-center align-items-center border rounded p-5 w-25 flex-column'>
            ...
            <div className='d-flex justify-content-between w-100 mt-5'>
              ...
              <div className='d-flex mt-5' >
                <input type="text" className='form-control' placeholder='Enter the number to be incremented' onChange={e=>setAmount(e.target.value)}/>
                <button className='btn btn-primary ms-3' onClick={handleIncrement}>Increment the number</button>
              </div>
        </div>
    </div>
  )
